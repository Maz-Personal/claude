"""
RMBS Wheel Strategy — Paper Trading
...
STATE_FILE      = "rmbs_wheel_state.json"
    ...
    if position is None:
        ...
        if stage == "PUT":
            ...
            if stock:
                ...
                save_state(state)
                log(f"*** ASSIGNED ***  Bought {shares} RMBS @ ${avg_entry:.2f}")
...
def main():
    print("=" * 60)
    print(f"  RMBS WHEEL STRATEGY  —  Paper Trading")
