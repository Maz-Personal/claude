"""
INTC Wheel Strategy — Paper Trading
...
STATE_FILE      = "intc_wheel_state.json"
    ...
    if position is None:
        ...
        if stage == "PUT":
            ...
            if stock:
                ...
                save_state(state)
                log(f"*** ASSIGNED ***  Bought {shares} INTC @ ${avg_entry:.2f}")
...
def main():
    print("=" * 60)
    print(f"  INTC WHEEL STRATEGY  —  Paper Trading")
