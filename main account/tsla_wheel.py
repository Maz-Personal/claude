"""
TSLA Wheel Strategy — Paper Trading
...
STATE_FILE      = "tsla_wheel_state.json"
    ...
    if position is None:
        ...
        if stage == "PUT":
            ...
            if stock:
                ...
                save_state(state)
                log(f"*** ASSIGNED ***  Bought {shares} TSLA @ ${avg_entry:.2f}")
...
def main():
    print("=" * 60)
    print(f"  TSLA WHEEL STRATEGY  —  Paper Trading")
